...
public class Lexer {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\12\0\1\1\3\2\42\0\12\3\7\0\32\3\6\0"+
    "\32\3\12\0\1\2\u01a2\0\2\2\326\0\u0100\2";
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 7: break;
          case 4:
            { cont_word++; cont_char += yytext().length();
            }
          // fall through
          case 8: break;
          default:
